...
Revision ID: cfb51e2bc8e7
Revises: 2488acdeaa11
Create Date: 2025-11-09 12:12:30.486271+00:00
...
revision = "cfb51e2bc8e7"
down_revision = "2488acdeaa11"
branch_labels = None
depends_on = None


def upgrade() -> None:
    """Upgrade database schema by creating all tables."""
    # Create Users table
    op.create_table(
        "users",
