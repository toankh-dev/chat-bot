...
class DocumentUploadService(IDocumentUploadService):
    def __init__(
        self, file_storage_service: IFileStorageService, document_repository: DocumentRepository
    ):
    ...
    async def upload_document(
        self, file_content: BinaryIO, filename: str, content_type: str, user_id: str, domain: str
    ) -> DocumentEntity:
